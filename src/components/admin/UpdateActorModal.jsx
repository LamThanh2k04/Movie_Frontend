...
import { updateActor } from '../../services/admin/actorApi'
import toast from 'react-hot-toast'
import { Upload, X } from 'lucide-react'

const UpdateActorModal = ({ open, onClose, fetchActors, actor }) => {
    ...
    useEffect(() => {
        if (actor) {
            setFormData({
                name: actor.name || "",
                anotherName: actor.anotherName || "",
                dateOfbirth: actor.dateOfbirth
                    ? actor.dateOfbirth.split("T")[0]
                    : "",
